...
- `graph/graph.json` — node/edge graph (19 acts, 41 confirmed relationships, 2 needs_review); `confirmed` edges sourced from reviewed metadata, `needs_review` edges from auto-detected references
