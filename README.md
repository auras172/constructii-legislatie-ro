...
- `graph/graph.json` — node/edge graph (19 acts, 43 confirmed relationships, 0 needs_review); `confirmed` edges sourced from reviewed metadata. All auto-detected references reviewed for current corpus (0 pending).
