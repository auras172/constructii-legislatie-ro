...
|------|-----------|---------------|--------|---------|------|
| [107](./INDEX.md) | 15 | 92 | [100/100](./reports/repository-health.md) | [MIT](./LICENSE) | [v1](./ocki-manifest.json) |
...
- `graph/graph.json` — node/edge graph (107 acts, 165 confirmed relationships, 0 needs_review); `confirmed` edges are sourced from reviewed metadata. All auto-detected references are reviewed for the current corpus (0 pending).
