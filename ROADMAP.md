...
- 237 acts tracked: 50 full-text and 187 metadata-only.
- 237 graph nodes and 432 confirmed relationships.
...
- Reconcile the 237-act `INDEX.md` matrix with the generated manifest and health reports.
